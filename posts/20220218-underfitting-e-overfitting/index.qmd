...
aliases:
    ...
    - /posts/underfitting-e-overfitting
categories: ["Machine Learning"]
image: "https://images2.imgbox.com/20/67/cDcK6ajL_o.png"
---

Underfitting e overfitting são problemas em machine learning supervisionado que podem aparecer nos modelos e está relacionado com o [trade-off de viés e variância](/knowledge/20220130-trade-off-vies-variancia/).
...
Para identificar se o modelo está sofrendo com o problema de underfitting e overfitting é preciso olhar para suas métricas de desempenho. Para medir o desempenho do modelo é necessário fazer a [divisão dos dados em treino, validação e teste](/knowledge/20220215-treino-teste-validacao/) e validar as previsões com, por exemplo, a técnica de [validação cruzada](https://en.wikipedia.org/wiki/Cross-validation_(statistics)).
...
![Exemplo de overfitting. Fonte: Wikipédia.](https://images2.imgbox.com/a9/17/X9bOZXUM_o.png){#fig-1}

Observe que na @fig-1 a linha verde separa perfeitamente os pontos vermelhos dos pontos azuis. Esse é um exemplo de overfitting, pois o algoritmo provavelmente não vai conseguir fazer essa separação perfeita com novos dados.

:::{.column-screen}

![Exemplos de modelos com underfitting, overfitting e balanceado.](https://images2.imgbox.com/20/67/cDcK6ajL_o.png){#fig-2}

:::

Na @fig-2 temos três situações, o modelo com underfitting, o modelo balanceado (ideal) e o modelo com overfitting.
