...
Em modelos de [aprendizado supervisionado](/knowledge/20220202-aprendizado-supervisionado-vs-nao-supervisionado/) é de suma importância mensurar o erro e a precisão das previsões para que o modelo se ajuste de acordo. Mais importante ainda é que as previsões sejam não-viesadas, ou seja, que o modelo  performe bem em dados diferentes daqueles usados na etapa do treino.
