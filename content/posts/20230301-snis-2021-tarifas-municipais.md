---
title: "Visualizando as Tarifas Municipais do Saneamento Básico no Brasil"
...
- **Tabela de Municípios - Diretórios Brasileiros - Base dos Dados**: Para facilitar o trabalho com dados geográficos utilizou-se essa tabela para o join entre os shapefiles do IBGE e os dados do SNI. Fonte: [Base dos Dados](https://basedosdados.org/dataset/br-bd-diretorios-brasil?bdm_table=municipio)
